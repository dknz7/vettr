...
When sending data to the **Google Gemini API**, compile your choices into a single JSON object (using the Dense Narrative structure above) and pass it as the prompt file to `generate_image.py`.
{
