# Nano Banana - Gemini Project Organizer

This document tracks our progress, generated assets, and custom scripts for the Nano Banana image generation project using Google's Gemini image generation API.
...
|-------------|---------|--------|
| `generate_image.py` | Python script to call Google Gemini image API and save result | Active |
